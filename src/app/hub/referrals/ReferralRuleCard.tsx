      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-3 text-xs text-zinc-500">{getRuleTypeDescription(rule.ruleType)}</p>
          </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <div className="xl:col-span-2">
            <label className="mb-1 block text-sm font-medium text-zinc-400">Rule Name</label>
            <input
              type="text"
              value={rule.name}
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-zinc-400">Rule Type</label>
            <select
              value={rule.ruleType}
              onChange={(event) =>
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <div>
            <label className="mb-1 block text-sm font-medium text-zinc-400">Spend Threshold</label>
            <input
              min={0}
              type="number"
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-zinc-400">Reward Type</label>
            <select
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-zinc-400">Reward Value</label>
            <input
              min={0}
              type="number"
        ...
        <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_220px]">
          ...
          <div className="rounded-xl border border-zinc-800 bg-[#111219] p-4">
            <p className="text-sm font-semibold text-white">Rule Status</p>
            <p className="mt-1 text-xs text-zinc-500">
              Disable a card to leave it in the planning deck without affecting results.
            </p>
            <label className="mt-4 flex items-center justify-between gap-3 text-sm text-zinc-300">
