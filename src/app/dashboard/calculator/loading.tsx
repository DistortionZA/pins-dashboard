      ...
      <div className="max-w-4xl space-y-6">
        <div className="rounded-2xl border border-zinc-800 bg-[#0b0c10] p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="h-11 rounded-lg bg-zinc-900" />
            <div className="h-11 rounded-lg bg-zinc-900" />
            <div className="h-11 rounded-lg bg-zinc-900" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="h-40 rounded-2xl border border-blue-500/20 bg-[#0b0c10]" />
          <div className="h-40 rounded-2xl border border-zinc-800 bg-[#0b0c10]" />
        </div>
      </div>
    </div>
  )
